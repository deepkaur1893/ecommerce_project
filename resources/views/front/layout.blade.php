...
<html lang="en">
  ...
  <script type="{{asset('front_assets/text/javascript" src="js/jquery.smartmenus.js')}}"></script>
  <!-- SmartMenus jQuery Bootstrap Addon -->
  <script type="{{asset('front_assets/text/javascript" src="js/jquery.smartmenus.bootstrap.js')}}"></script>  
  <!-- To Slider JS -->
